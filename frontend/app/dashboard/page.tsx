...
import { Bot, Database, FileText, PanelsTopLeft } from "lucide-react";
...
function Dashboard() {
  const { user } = useUser();
  return (
    <div className="flex flex-col items-center mt-2 dark:bg-darkPrimary bg-white gap-2 z-0 pb-32">
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-2 max-w-5xl mx-auto gap-6 px-4 my-6">
        <div className="hover:bg-gray-100 dark:hover:bg-darkSecondary p-6 rounded-md cursor-pointer border-2 max-w-lg">
